// ╔══════════════════════════════════════════════════════════════════════════╗
// ║  BPC NOC — HEADER-LITE (cópia de _comum/header-lite.js)        v1 · ES5   ║
// ║  Dashboard: N3 · Serviços de Suporte · Serviço                            ║
// ║  Só CFG.rootId e CFG.nocLabel diferem do canónico — melhorias fazem-se    ║
// ║  primeiro em _comum/header-lite.js e propagam-se para aqui.               ║
// ╚══════════════════════════════════════════════════════════════════════════╝
...
(function () {
  ...
  var CFG = {
    rootId: 'bt-sup3-hdr',
    nocLabel: 'SERVIÇOS DE SUPORTE - SERVIÇO',
    title: 'BPC NOC',
