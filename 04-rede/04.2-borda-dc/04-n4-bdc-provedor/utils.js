...
const CFG_HEADER = {
  ...
  title: 'BPC NOC',
  nocLabel: 'REDE · BORDA DC · PROVEDOR — NÍVEL 4',
  subtitle: 'Banco de Poupança e Crédito · Centro de Operações de Rede',
  backLink: { url: '/d/rede-n3-bdc-provedores', label: '← N3 · Borda DC — Provedores' },
  // objectContext.labelMap: a variável $provider guarda a alternação regex
  // directamente como valor (ver l4-prov-* e manifest.json) — o URL nunca
  // tem o label bonito, só o valor bruto. Este mapa tem de ficar em sync
  // manual com a lista `provider_query` do script de criação do dashboard.
  objectContext: {
    urlVars: ['provider'],
    labelMap: {
      'UNITEL': 'UNITEL',
      'MST|MSTELECOM|MSTELCOM|KWANZA': 'MST / MSTELECOM',
      'ATELECOM|BGP_PEER_AT|SP_AT': 'AT / ANGOLA TELECOM',
      'ITA': 'ITA',
      'MULTITEL': 'MULTITEL',
      'IPWORLD': 'IPWORLD',
      'CONNECTIS': 'CONNECTIS',
      'Po2\\.293[12]|EXPRESSROUTE|AZURE': 'AZURE',
    },
  },
};
