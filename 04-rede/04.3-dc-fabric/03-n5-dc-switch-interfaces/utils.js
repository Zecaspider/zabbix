...
const CFG_HEADER = {
  ...
  title: 'BPC NOC',
  nocLabel: 'REDE · DC FABRIC · SWITCH · INTERFACES — NÍVEL 5',
  subtitle: 'Banco de Poupança e Crédito · Centro de Operações de Rede',
  backLink: { url: '/d/rede-n4-dc-fabric-switch', label: '← N4 · DC Fabric — Switch' },
  objectContext: { urlVars: ['switchName', 'iface'] },
};
