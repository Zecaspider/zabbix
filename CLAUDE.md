...
| **Naming de dashboards** | Título: `Nx · Domínio [· Âmbito] — Propósito` (prefixo Nx obrigatório para ordenação por nível; sentence case; ` · ` entre hierarquia; ` — ` antes do propósito). UID: `dominio.nivel.funcao`. Detalhes e exemplos em `documentacao/engenharia-do-sistema.md §4.0` |
