...
> - **Fora desta pasta** — `C:\Repositorios\zabbix\bpc-workspace\mapeamento-apps-vms-webscenarios-handoff-20260705.md` — **PONTO DE ENTRADA** para continuar o mapeamento sistemas de negócio → VM → web scenario → dashboard Grafana (Fase 14.17/14.18 do `cronograma.md`); inclui o deliverable `Mapa_VMs_Servicos_Zabbix_Grafana.xlsx`, a auditoria da tag `servico`, e a arquitectura Grafana de 2 eixos ainda por construir
