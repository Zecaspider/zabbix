...
Última actualização: 2026-06-29 (§9.4 T-08 ☑ — `l5-utilizacao.js` (id=101) N5: barras RX%/TX% para físicas, N/A para túneis, modo All filtra activas. Validado 3 cenários. §9.10 + §9.11 ☑ sessão anterior.)
