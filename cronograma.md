...
Última actualização: 2026-06-28 (9.6 v1: painel N4 **Operadoras WAN · hub DMVPN** (`l4-provider-context.js` id 211) — Transporte+Pulso por operadora, distingue outage-de-provider de problema-local; premissa corrigida; bug latente apiUrl N4→Network corrigido; validado caso CUNHINGA. ANTES: 9.4 T-06 dropdown `iface` N5 → MySQL com contexto do provider. Docs `fluxo-agencias-n4-n5.md` §9.6/§Decisão iface MySQL)
