...
const CFG_HEADER = {
  ...
  title: 'BPC NOC',
  nocLabel: 'APIS E SERVICOS - NIVEL 4 - SISTEMA',
  subtitle: 'Banco de Poupança e Crédito · Centro de Operações de Rede',
  backLink: { url: '/d/apis-n3/n3-c2b7-apis-e-servicos-e28094-app', label: '← N3 · Detalhe da app' },
  objectContext: { urlVars: ['servico'] },
};
